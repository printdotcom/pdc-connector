...
<div>
    <div class="options_group pdc_product_options" id="js-pdc-variant-<?= $variation->ID; ?>">
        <p class="form-field">
            ...
            <input id="<?= $variantion_ID; ?>_pdc-connector_preset_id" value="<?= $preset_id; ?>" class="js-pdc-preset-id" name="pdc-connector_preset_id" />
            <input id="<?= $variantion_ID; ?>_pdc-connector_preset_title" value="<?= $preset_title; ?>" class="js-pdc-preset-title" name="pdc-connector_preset_title" />
        </p>
