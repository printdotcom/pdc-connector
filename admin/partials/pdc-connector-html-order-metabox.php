<div class="wp-list-table pdc-table widefat fixed striped posts">
    ...
    <div class="table-body">
        ...
        foreach ($post->get_items() as $order_item_product) {
            ...
            $pdc_preset_name = $product->get_meta($this->plugin_name . '_preset_name');
                ...
                <div class="table-row-contents" id="pdc_order_item_<?= $order_item_id; ?>_inner">
                    <div class="table-cell">
                        ...
                        <div class="notifications">
                            <?php if (!$has_file) { ?><p>Missing file. Upload one to purchase.</p> <?php } ?>
                            <?php if (!$has_preset) { ?><p> Missing preset. You need a connected preset on the product to purchase. </p><?php } ?>
                        </div>
                    </div>
                    <div class="table-cell">
                        <div class="actions">
