...
$pdc_connector_product_config = get_option( PDC_CONNECTOR_NAME . '-product' );
		...
		<tr>
			...
			<td>
				<label for="pdc_use_preset_copies">
					<input type="checkbox" id="pdc_use_preset_copies" data-testid="pdc-use_preset_copies" name="<?php echo esc_attr( PDC_CONNECTOR_NAME ); ?>-product[use_preset_copies]" value="1" <?php checked( $pdc_connector_use_preset_copies, true ); ?> />
