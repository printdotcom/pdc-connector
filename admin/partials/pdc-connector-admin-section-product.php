...
$product_use_preset_copies = isset( $pdc_product_config['use_preset_copies'] ) ? $pdc_product_config['use_preset_copies'] : false;
?>

<p>Configure how to set up the product connection with Print.com.</p>
		...
		<tr>
			...
			<td>
				<label for="pdc_use_preset_copies">
					<input type="checkbox" id="pdc_use_preset_copies" data-testid="pdc-use_preset_copies" name="<?php echo $this->plugin_name; ?>-product[use_preset_copies]" value="1" <?php checked( $product_use_preset_copies, true ); ?> />
